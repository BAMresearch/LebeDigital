...
class ExpStep():
    ...
    @staticmethod
    def get_spaces(o: Openbis):
        return o.get_spaces().df
    ...
    @staticmethod
    def get_projects(o: Openbis, space: str):
        return o.get_space(space).get_projects().df
    ...
    @staticmethod
    def get_experiments(o: Openbis, space: str, project: str):
        return o.get_space(space).get_project(project).get_experiments().df
