...
def test_homogenization():
    ...
    parameters['paste_C'] = 870 * ureg('J/kg/K')  # Specific Heat Capacity
    ...
    parameters['aggregates_C'] = 840 * ureg('J/kg/K')  # Specific Heat Capacity
    ...
    assert_approx(results['C'], 2145600.0 * ureg('J/m^3/K'), rtol=0.001)
