...
\begin{figure}[b]%
	...
	\caption{Classical design approach, where the required material properties are defined before the mix is defined. \ET{It might be possible to improve the design of this and the next figure. The content should not necessarily need changes.}}\label{fig:standard_design}
\end{figure}
