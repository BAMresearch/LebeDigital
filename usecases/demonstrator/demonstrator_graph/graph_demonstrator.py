...
dot.edge('length','co2 computation volume')
...
dot.edge('length', 'load bearing capacity')
...
dot.node('geometry', 'cross section: width, height', color=input, shape='rectangle')
dot.node('length', 'beam span', color=input)
dot.edge('geometry', 'fem model')
dot.edge('length', 'fem model')
...
dot.node('steel strength', 'steel yield strenght [N/mm2]', color=input)
dot.edge('steel strength', 'load bearing capacity')
dot.edge('steel strength', 'fem model')
dot.node('steel', 'steel: diameter [mm],\n n bars', color=input)
dot.edge('steel', 'fem model')
dot.edge('steel', 'load bearing capacity')
dot.edge('steel', 'co2 computation volume')

dot.node('concrete cover', 'concrete: cover [mm]', color=input)
dot.edge('concrete cover', 'fem model')
dot.edge('concrete cover', 'load bearing capacity')


#dot.node('steel', 'steel: diameter [mm],\n n bars, yield strenght [N/mm2] \nload: point [N], distributed [N/m]\n concrete: cover [mm]', color=input)
