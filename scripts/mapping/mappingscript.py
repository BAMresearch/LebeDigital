...
#from scripts.mapping.check_duplicate import check_mix_metadata
...
def placeholderreplacement(kgPath, metadata):
    ...
    with open(kgPath, 'r') as file:
        ...
        for i in range(len(lines)):
            ...
            if "##SpecimenShape##" in lines[i]:
                logger.debug('Found SpecimenShape placeholder "##SpecimenShape##" with value "' \
